...
public class AdminOrderService {
    ...
    private void validateTransition(OrderStatus current, OrderStatus target) {
        ...
        Set<OrderStatus> allowedTargets = switch (current) {
            case PENDING -> EnumSet.of(OrderStatus.PAID, OrderStatus.PROCESSING, OrderStatus.CANCELLED);
            case PAID -> EnumSet.of(OrderStatus.PROCESSING, OrderStatus.CANCELLED, OrderStatus.REFUNDED);
            case PROCESSING -> EnumSet.of(OrderStatus.SHIPPED, OrderStatus.CANCELLED, OrderStatus.REFUNDED);
            case SHIPPED -> EnumSet.of(OrderStatus.DELIVERED, OrderStatus.REFUNDED);
            case DELIVERED -> EnumSet.of(OrderStatus.REFUNDED);
